var Aubio = function (Aubio) {
    ...
    (function () {
        ...
        function d(a) {
            ...
            Ka(f) || "function" !== typeof fetch ? g(e) : WebAssembly.instantiateStreaming(fetch(f, {credentials: "same-origin"}), h).then(e).catch(function (a) {
                                ...
                                if (192 == (f & 224)) e += String.fromCharCode((f & 31) << 6 | k); else {
                                    ...
                                    if (224 == (f & 240)) f = (f & 15) << 12 | k << 6 | l; else {
                                        ...
                                        if (240 == (f & 248)) f = (f & 7) << 18 | k << 12 | l << 6 | h; else {
                                            var bb = d[b++] & 63;
                                            if (248 ==
                                                (f & 252)) f = (f & 3) << 24 | k << 18 | l << 12 | h << 6 | bb; else {
                                                var m = d[b++] & 63;
    ...
    var Bb = [], Y = [{}, {value: void 0}, {value: null}, {value: !0}, {value: !1}];
    ...
    U.prototype.fromWireType = function (a) {
        ...
        return null === f ? b.call(this) : this.D ? rb(e.b.u, {f: e, c: f, h: this, g: a}) : rb(e.b.u, {f: e, c: f})
    };
    ...
    c.N = {};
    c.O = {
        abort: y, enlargeMemory: function () {
            ya()
        }, getTotalMemory: function () {
            return E
        }, abortOnCannotGrowMemory: ya, ___setErrNo: function (a) {
        ...
        }, ___syscall146: J, ___syscall54: function (a, b) {
            H = b;
            return 0
            ...
            Ya([], [a], function (a) {
                ...
                Ya([], m, function (e) {
                    ...
                    var t = null !== e[1] && null !== g, D = !1;
                    for (g = 1; g < e.length; ++g) if (null !== e[g] && void 0 === e[g].l) {
                        D = !0;
                        break
                    }
                    var mb = "void" !== e[0].name, N = "", W = "";
            ...
            Q(a, {
                name: b, fromWireType: function (a) {
                    ...
                    return b
                                         ...
                                         b) {
                    return T(b)
                }, argPackAdvance: 8, readValueFromPointer: lb, l: null
            })
            ...
            Q(a, {
                name: b, fromWireType: function (a) {
                    ...
                    return b
                }, argPackAdvance: 8, readValueFromPointer: Db(b, d), l: null
            })
            ...
            Q(a, {
                name: b, fromWireType: l, toWireType: function (a, d) {
                    ...
                    return m ? d >>> 0 : d | 0
                }, argPackAdvance: 8, readValueFromPointer: Eb(b, h, 0 !== e), l: null
            })
            ...
            d = K(d);
            Q(a, {name: d, fromWireType: e, argPackAdvance: 8, readValueFromPointer: e}, {X: !0})
            ...
            Q(a, {
                name: b, fromWireType: function (a) {
                    ...
                    null !== a && a.push(X, m);
                    return m
                }, argPackAdvance: 8, readValueFromPointer: lb, l: function (a) {
                    X(a)
                }
            })
            ...
            b =
                K(b);
            Q(a, {
                da: !0, name: b, argPackAdvance: 0, fromWireType: function () {
                }, toWireType: function () {
                }
            })
        ...
        }, __emval_decref: Cb, __emval_get_property: function (a, b) {
            a = Z(a);
            b = Z(b);
            return T(a[b])
            ...
            return a
        }, _llvm_cos_f32: Ha, _llvm_log10_f32: function (a) {
            return Math.log(a) / Math.LN10
        }, _llvm_sin_f32: Ia, DYNAMICTOP_PTR: xa, STACKTOP: ua
    };
    ...
    function Nb() {
        ...
        if (!(0 < F)) {
            if (c.preRun) for ("function" == typeof c.preRun && (c.preRun = [c.preRun]); c.preRun.length;) Ga();
            Aa(Ba);
